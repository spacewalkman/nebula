...
public:
    ...
    folly::Future<cpp2::ExecResp> future_removeHosts(const cpp2::RemoveHostsReq &req) override;
    ...
    folly::Future<cpp2::GetUserResp> future_getUser(const cpp2::GetUserReq &req) override;
    ...
    folly::Future<cpp2::ExecResp> future_changePassword(
        const cpp2::ChangePasswordReq &req) override;

    folly::Future<cpp2::ExecResp> future_checkPassword(const cpp2::CheckPasswordReq &req) override;
    ...
    folly::Future<cpp2::ListConfigsResp> future_listConfigs(
        const cpp2::ListConfigsReq &req) override;

    /**
     * import data related
     */
    folly::Future<cpp2::LongRunningJobResp> future_downloadSstFiles(
        const ::nebula::cpp2::DownloadSstFilesReq &req) override;

    folly::Future<cpp2::LongRunningJobResp> future_ingestSstFiles(
        const ::nebula::cpp2::IngestSstFilesReq &req) override;

    //    folly::Future<cpp2::UpdateProgressResp> future_updateProgress(
    //        const ::nebula::cpp2::UpdateProgressReq &req) override;

    folly::Future<cpp2::ShowDownloadJobResp> future_showDownloadJob(
        const cpp2::ShowImportJobReq &req) override;

    folly::Future<cpp2::ShowIngestJobResp> future_showIngestJob(
        const cpp2::ShowImportJobReq &req) override;

    folly::Future<cpp2::KillJobResp> future_killJob(const cpp2::KillJobReq &req) override;
