...
folly::Future<cpp2::ExecResp> MetaServiceHandler::future_removeHosts(
    const cpp2::RemoveHostsReq& req) {
...
folly::Future<cpp2::GetUserResp> MetaServiceHandler::future_getUser(const cpp2::GetUserReq& req) {
...
folly::Future<cpp2::ExecResp> MetaServiceHandler::future_checkPassword(
    const cpp2::CheckPasswordReq& req) {
...
folly::Future<cpp2::LongRunningJobResp> MetaServiceHandler::future_downloadSstFiles(
    const ::nebula::cpp2::DownloadSstFilesReq& req) {
    auto* processor = DownloadSstFilesProcessor::instance(kvstore_);
    RETURN_FUTURE(processor);
}

folly::Future<cpp2::LongRunningJobResp> MetaServiceHandler::future_ingestSstFiles(
    const ::nebula::cpp2::IngestSstFilesReq& req) {
    auto* processor = IngestSstFilesProcessor::instance(kvstore_);
    RETURN_FUTURE(processor);
}

// folly::Future<cpp2::UpdateProgressResp> MetaServiceHandler::future_updateProgress(
//    const cpp2::UpdateProgressReq& req) {
//    auto* processor = UpdateProgressProcessor::instance(kvstore_);
//    RETURN_FUTURE(processor);
//}

folly::Future<cpp2::ShowDownloadJobResp> MetaServiceHandler::future_showDownloadJob(
    const cpp2::ShowImportJobReq& req) {
    auto* processor = ShowDownloadJobProcessor::instance(kvstore_);
    RETURN_FUTURE(processor);
}

folly::Future<cpp2::ShowIngestJobResp> MetaServiceHandler::future_showIngestJob(
    const cpp2::ShowImportJobReq& req) {
    auto* processor = ShowIngestJobProcessor::instance(kvstore_);
    RETURN_FUTURE(processor);
}

folly::Future<cpp2::KillJobResp> MetaServiceHandler::future_killJob(const cpp2::KillJobReq& req) {
    auto* processor = KillJobProcessor::instance(kvstore_);
    RETURN_FUTURE(processor);
}
